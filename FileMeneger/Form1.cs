...
namespace файловый_менеджер
{
    public partial class Form1 : MetroFramework.Forms.MetroForm
    {
        ...
        private void Form1_Load(object sender, EventArgs e)
        {
            ...
            notifyIcon1.BalloonTipTitle = "File Menedger Elizaveta Ustinova"; // отображение для уведоблений
            notifyIcon1.BalloonTipText = "File Menedger"; // отображение для уведоблений
